...
include("conne.php");
    if (isset($_POST['modifier'])) {
        if(!empty($_POST['nomA'])&& !empty($_POST['prenomA'])&&!empty($_POST['dateN'])){
            ...
            $query="UPDATE auteur SET nom='$_POST[nomA]', prenom='$_POST[prenomA]',dateN='$_POST[dateN]', srcA='$srcA' where id=$id";
            mysqli_query($con,$query);
            header("Location:our-authorAdmin.php");
            }else{
                echo("<SCRIPT LANGUAGE='JavaScript'>
                window.alert('veuillez remplire tous les champs');
                </SCRIPT>");
            }
    }
     ?>
    ...
    <div class="nav" id="nav">          
            ...
            <div class="nav-cont">
                <a class="active" href="our-authorAdmin.php">Nos Auteurs</a> 
            </div>  
            <div class="nav-cont">
